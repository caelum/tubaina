...
import br.com.caelum.tubaina.builder.replacer.RefReplacer;
...
public class ChunksMakerBuilder {
    ...
    private String paragraphTerminator = "java|box|code|img|list|xml|exercise|note|answer|item|question|todo|index|ruby|table|row|center|ref";
